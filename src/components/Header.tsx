    ...
    <header className="fixed top-0 w-full bg-gray-900/50 backdrop-blur-sm z-10">
      <nav className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <span className="text-xl font-bold text-white">hernan.dev</span>
          <div className="flex gap-4">
            ...
            <a href="https://www.linkedin.com/in/hernanchamorrodev/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <Linkedin size={20} />
            </a>
            <a href="mailto:hernanchamorrodev@gmail.com" className="text-gray-400 hover:text-white transition-colors">
              <Mail size={20} />
            </a>
          </div>
        </div>
